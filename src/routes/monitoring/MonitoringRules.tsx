  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 pb-20">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        <div>
          <h1 className="text-3xl font-bold text-ois-text tracking-tight mb-2">Monitoring Rules</h1>
          <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm font-medium text-ois-text-muted">
            <span className="flex items-center gap-1.5"><Shield size={16} /> {stats.totalCount} rules</span>
            ...
            <span className="w-1 h-1 rounded-full bg-ois-border" />
            <span className="flex items-center gap-1.5">Avg Signal/Noise: <span className={cn(
              "font-bold",
